...
const Testimonials = () => {
  const row1 = [...reviewsData.slice(0, 3), ...reviewsData.slice(0, 3), ...reviewsData.slice(0, 3)];
  const row2 = [...reviewsData.slice(3, 6), ...reviewsData.slice(3, 6), ...reviewsData.slice(3, 6)];
    ...
    <section id="testimonials" className="testimonials-marquee-section">
      ...
      <div className="container">
        <div className="portfolio-header center-text">
          ...
          >
            Trusted by founders and product teams globally. Join 50+ partners who chose excellence.
          </motion.p>
        </div>
      </div>
